        ...
        <div className="space-y-6">
          <Card>
            <CardContent className="p-6 text-center">
              <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-neutral-100 text-neutral-600">
              ...
              {specialist.bio && (
                <p className="mt-4 text-sm text-neutral-600">{specialist.bio}</p>
              )}
